from typing import TypeVar, Generic, Any, overload, List, Tuple, Optional, Generator
...
class Query(Generic[T]):
    ...
    @overload
    def __call__(self, entity0: Field[T0]) -> Query[T0]: ...
    @overload
    def __call__(self, entity0: Field[T0], entity1: Field[T1]) -> Query[Tuple[T0, T1]]: ...
    @overload
    def __call__(self, entity0: Field[T0], entity1: Field[T1], entity: Field[T2]) -> Query[Tuple[T0, T1, T2]]: ...
    @overload
    def __call__(self, entity0: Field[T0], entity1: Field[T1], entity2: Field[T2], entity3: Field[T3]) -> Query[Tuple[T0, T1, T2, T3]]: ...
    @overload
